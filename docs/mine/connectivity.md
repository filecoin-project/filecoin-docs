...
If you fail to succeed in any of these steps, please start a thread on `#fil-testnet` in the [Filecoin Slack](http://filecoin.io/slack). Please include all of the steps you have tried, their output, and your miner ID.
