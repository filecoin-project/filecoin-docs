...
The pledge period for the sector can be around 6-18 months(18 months by default). The _upgrading_ process allows however to recover pledged sectors for re-use much more quickly. The following command marks a sector for _upgrade_:
