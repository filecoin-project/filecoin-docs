...
The pledge period for the sector can be between 6 to 18 months. 18 months is the default. The _upgrading_ process allows however to recover pledged sectors for re-use much more quickly. The following command marks a sector for _upgrade_:
