...
| Store data | 1. Package your data.<br> 2. Import your data into Lotus.<br> 3. Find a storage provider through the MinerX program.<br> 4. Create a storage deal.<br> 5. Wait for the deal to complete. |
