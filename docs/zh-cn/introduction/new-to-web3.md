...
如果你正准备了解 Filecoin 和 web3，这里会是一个不错的起点！下面列出的资料可以帮助你了解一些核心概念，它们让 [IPFS](https://ipfs.io)、[Filecoin](https://filecoin.io)、[Powergate](https://github.com/textileio/powergate) 等技术成为可能。
