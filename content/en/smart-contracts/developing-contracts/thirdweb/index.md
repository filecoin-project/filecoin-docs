...
lead: "thirdweb is a complete web3 development framework that provides everything you need to connect your apps and games to decentralized networks."
draft: false
images: []
type: docs
menu:
...
5. After modifying your contract with your desired custom logic, you may deploy it to Filecoin EVM using [Deploy](https://portal.thirdweb.com/deploy).
...
1. Go to the thirdweb Explore page: https://thirdweb.com/explore
   ...
   ![thirdweb Explore page](thirdweb-explore.png)
...
3. Select Filecoin as the network
