...
As a simple introduction, we're going to use Remix to create an ERC-20 token on the Filecoin network. In this guide, we're using the Hyperspace [testnet](https://docs.filecoin.io/reference/general/glossary/#testnet), but this process is the same for mainnet.
