...
{{< alert >}}
This guide assumes you've already connected your MetaMask extension to a Filecoin network. If you haven't done so yet, [check out this guide to add the Hyperspace testnet to MetaMask]({{< relref "/networks/hyperspace/add-to-metamask" >}}).
{{< /alert >}}
