...
Factor8, the team that runs the Hyperspace testnet, has a [guide on how to spin up a Lotus node on the Hyperspace testnet](hhttps://kb.factor8.io/docs/filecoin/testnets/hyperspace).
