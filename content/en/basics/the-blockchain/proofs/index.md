...
- All [blockchain](https://docs.filecoin.io/reference/general/glossary/#blockchain) networks seek to achieve _{{< tooltip "consensus" >}}_, and rely on proofs as part of this process.  
...
In Filecoin, this process is known as [_Proof-of-Storage_](https://docs.filecoin.io/reference/general/glossary/#proof-of-storage), and consists of two distinct types of proofs:

- [Proof of Replication (PoRep)](#-porep): a procedure used at the time of initial data storage to validate that an SP has _created and stored_ a unique copy of some piece of data.
...
In the Filecoin storage lifecycle process, [_Proof-of-Replication](https://docs.filecoin.io/reference/general/glossary/#proof-of-replication-porep) (PoRep)_ is used when an SP agrees to store data on behalf of a client and receives a piece of client data. In this process:
...
- The [storage provider](https://docs.filecoin.io/reference/general/glossary/#storage-provider) who seals the data.
...
Because this method is concerned with proving that data is being stored in a particular _space_ for a particular period or at a particular _time_, it is called [_Proof-of-Spacetime](https://docs.filecoin.io/reference/general/glossary/#proof-of-spacetime-post) (PoSt)_. In Filecoin, the PoSt process is handled using two different sub-methods, each of which serves a different purpose:

- [WinningPoSt](#winningpost) is used to prove that an SP selected using an election process has a replica of the data at the specific time that they were asked and is used in the [block](https://docs.filecoin.io/reference/general/glossary/#block) consensus process. 
