...
Specifically, Filecoin uses a [dual minting model](https://spec.filecoin.io#section-systems.filecoin_token.minting_model) for [block](https://docs.filecoin.io/reference/general/glossary/#block) reward minting:
