...
description: "Smart contracts can access built-in actor methods with the `filecoin.solidity` library, a set of Solidity libraries that allow Solidity smart contracts to seamlessly call methods of Filecoin built-in actors. The `filecoin.solidity` library supports cross-platform calls to real Filecoin built-in actors. This page contains working examples of smart contracts that call built-in actor methods."
lead: "Smart contracts can access built-in actor methods with the `filecoin.solidity` library, a set of Solidity libraries that allow Solidity smart contracts to seamlessly call methods of Filecoin built-in actors. The `filecoin.solidity` library supports cross-platform calls to real Filecoin built-in actors. This page contains working examples of smart contracts that call built-in actor methods."
draft: false
images: []
type: docs
menu:
