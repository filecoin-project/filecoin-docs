...
It is important to note that careful security measures are required to keep your Lotus wallets safe. This includes measures around physical access, network access, software security and making backups (that are also secured). As with any web3 wallet, access to the private key means access to your funds. It is as such highly recommended to keep the "owner" wallet on a hardware wallet. [Ledger is supported by Lotus](https://lotus.filecoin.io/lotus/manage/ledger/).
