...
MetaMask is compatible with the Ledger hardware wallet. There are 2 options for Ledger hardware wallet apps that support Filecoin:
- **Filecoin Ledger App** - compatible with the Glif.io wallet or MetaMask
