...
If you only need a managed IPFS pinning-style workflow, start with [Filecoin Pin](../cookbook/filecoin-pin/README.md). If you want to run provider infrastructure for the FOC stack, clone Curio, `docker compose up`, and follow [Curio-PDP](https://docs.curiostorage.org/getting-started/curio-pdp) ([PDP](../../storage-providers/pdp/README.md)).
...
| PDP provider | You want to run provider infrastructure that can participate in FOC storage. | [Curio-PDP](https://docs.curiostorage.org/getting-started/curio-pdp) · [PDP](../../storage-providers/pdp/README.md) |
