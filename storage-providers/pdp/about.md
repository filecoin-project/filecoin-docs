...
2. **Run PDP infrastructure** — clone Curio, start Docker, and follow [Curio-PDP](https://docs.curiostorage.org/getting-started/curio-pdp) ([Run a PDP provider](install-and-run-pdp.md)).
