...
Mining rewards are subject to a vesting schedule to support long-term network alignment. For instance, 75% of block rewards earned by miners vest linearly over 180 days, while 25% are immediately accessible, improving miner cash flow and profitability. Note that if the miner has incurred "[fee debt](../../core-concepts/filecoin-economics/slashing.md)," the immediately accessible block rewards will automatically go towards paying down those fees.
